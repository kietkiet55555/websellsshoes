        ...
        <div class="areashowshoes">
                    ...
                    <div id="option">
                            ...
                            <ul>
                                 <?php 
                                    ...
                                    $sqlCom2 = "SELECT DISTINCT theloai FROM khohang";
                                    $kqkt = mysqli_query($conn, $sqlCom2);
                                    while ($row = mysqli_fetch_array($kqkt)) {

                                        echo '<a href="theloai.php?theloai='.$row['theloai'].'"> <li> '.$row['theloai'].' </li></a> ';
                    ...
                    <div id="show">
                        <div id="areashow">
                                ...
                                $thuonghieu  = (isset($_GET['theloai'])) ? $_GET['theloai'] : null;
                                
                                    if($thuonghieu != null)
                                    {
                                
                                        unset($_SESSION['totalPages']);
                                        $sqlCom2 = "SELECT * FROM khohang where theloai like '$thuonghieu' ";
                                        $kqkt = mysqli_query($conn, $sqlCom2);
                                        $row_count = mysqli_num_rows($kqkt); 
                                        $_SESSION['rowcount'] = $row_count;      
                                        // Tính toán số lượng trang
                                    ...
                                    if(isset($_SESSION['totalPages']))
                                    {
                                        if($_SESSION['totalPages']!=1)
                                        {
                                                ...
                                                for ($i = max(1, $current_page - $range); $i <= min($current_page + $range, $total_pages); $i++) {
                                                    echo '<li><a href="?theloai='.$theloai.'&page=' . $i . '"';
                                                    if ($i == $current_page) {
                                                ...
                                                if ($total_pages > 3 && $current_page > 1) {
                                                    echo '<li><a href="theloai='.$theloai.'&?page=' . ($current_page - 1) . '">Trước</a></li>';
                                                }
                                                ...
                                                if ($total_pages > 3 && $current_page < $total_pages) {
                                                    echo '<li><a href="?theloai='.$theloai.'&page=' . ($current_page + 1) . '">Tiếp</a></li>';
                                                }
                                                echo '</ul>';
